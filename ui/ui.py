...
class Messages:
    ...
    def markup_editer(self,arg_text,markup):
        self.session.bot.edit_message_text(chat_id=self.session.id,message_id=self.markup[0],text=arg_text,reply_markup=markup)
...
person_list = [
    ...
    Person(3,"stf","Уилл Смит",3,1920,1977,"https://www.meme-arsenal.com/memes/259343770ad19e1dd9e5abd07e9d5b16.jpg"),
    Person(4,"act","Джим Керри",4,1990,2021,"https://www.shmyandeks.ru/wp-content/uploads/2014/07/djim_kerri_1.jpg")
]
